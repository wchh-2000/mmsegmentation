...
img_norm_cfg = dict(
    mean=[117.60938644,115.98219299,118.33253479],#shift4.png
    std=[20.8069714,20.73299022,24.21787756],
    to_rgb=True,norm_per_pic=False)
img_dir='/data/fusai_release/train/images/'
albumentations = [
    # dict(
    #     type='FDA',
    #     reference_images=[img_dir+'4.tif'],
    #     beta_limit=0.005,
    #     p=1),
    dict(
...
data = dict(
    samples_per_gpu=8,#12
    workers_per_gpu=8,
    train=dict(
        type=dataset_type,
        classes=CLASSES,
        img_dir='/data/fusai_release/train/images_fda',
    ...
    test=dict(
        type=dataset_type,
        classes=CLASSES,
        img_dir='/data/fusai_release/test/images_fda',
        img_suffix='.tif',
        seg_map_suffix='.png',
        k_fold_use=False,
